...
begin
  ...
  begin
   ...
   begin
    ...
    ShowMessage('Kiþi Kaydedilmiþtir');
  ...
  begin
    ShowMessage('ad ve numara boþ býrakmayýnýz');
  end;
...
Edit1.Clear;
    ...
    ComboBox1.ItemIndex := -1;
    ComboBox2.ItemIndex := -1;
         if  MessageDlg('Kiþiyi silmek istiyor musunuz?', mtconfirmation, [mbyes, mbno], 0)=mrYes then
               begin

  ListBox1.Items.Delete(secim);
   ListBox1.Items.SaveToFile('C:\Users\Yunus\OneDrive\Documents\Rehber.txt');
  ShowMessage('Kiþi Silinmiþtir');
               end;
...
begin
  ListBox1.Items.SaveToFile('C:\Users\Yunus\OneDrive\Documents\Rehber.txt');
  ShowMessage('Rehber güncellenmiþtir.');
end;
...
begin
 ...
 ListBox1.Items.Insert(0,UpperCase(Edit1.Text+' / '+Edit2.Text+' / '+Edit3.Text+' / '+Edit4.Text+' / '+Edit5.Text+' / '+ComboBox1.Text+' / '+ComboBox2.Text));
  ...
  ShowMessage('Kiþi güncellenmiþtir.');
